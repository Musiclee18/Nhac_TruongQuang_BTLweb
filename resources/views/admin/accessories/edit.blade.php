            ...
            <div class="card-body">
                ...
                <form action="{{route('accessories.update',[$accessories->id])}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" value="{{ $accessories->title }}" class="form-control" required name="title" placeholder="...">
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary">Cập nhập phụ kiện</button>
                </form>
            </div>
        </div>
    </div>
