    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <a href="{{route('blog.index')}}" class="btn btn-success">Liệt kê blogs game</a>
                <form action="{{route('blog.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="description" id="desc_blog" required placeholder="..."></textarea>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputPassword1">Content</label>
                        <textarea class="form-control" name="content" id="content_blog" required placeholder="..."></textarea>
                    </div>
